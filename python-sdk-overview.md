Below is a single **consolidated stub file** (`parallel_api_footprint.pyi`) that summarizes the *public* SDK/API footprint visible from the code you provided: top-level exports, client classes, primary resources and their methods, key models, and key TypedDict params (including beta endpoints and SSE streaming types).  

Notes:
- I only copied docstrings **verbatim** where they were present in the snippets you shared (mostly resource method docstrings and many model docstrings). If a symbol had no docstring in what you provided, I left it undocumented.
- This is a *summary stub*: it is not meant to be perfectly exhaustive of every internal helper module, but it captures the “how to use the API” surface area an LLM typically needs.

Save as: `parallel_api_footprint.pyi`

```pyi
# parallel_api_footprint.pyi
# A single-file stub summarizing the Parallel Python SDK public API footprint.
# Generated manually from provided source excerpts (not the full repository).
...
# =============================================================================
# Public re-exports / sentinel types
# =============================================================================
...
# =============================================================================
# Params for core TaskRun endpoints
# =============================================================================
...
# =============================================================================
# Beta TaskRun input/result + events
# =============================================================================
...
# =============================================================================
# Beta Search/Extract models + params
# =============================================================================
...
class FindAllCreateParams(TypedDict, total=False):
    ...
    match_conditions: Required[Iterable[Dict[str, object]]]
    """List of match conditions for the FindAll run."""
...
class AsyncTaskRunResource:
    ...
    @overload
    async def execute(self, *, input: Union[str, Dict[str, object]], processor: str, metadata: Optional[Dict[str, Union[str, float, bool]]] | Omit = ..., output: Optional[OutputSchemaParam] | Omit = ..., extra_headers: Headers | None = ..., extra_query: Query | None = ..., extra_body: Body | None = ..., timeout: float | httpx.Timeout | None | NotGiven = ...) -> TaskRunResult: ...
    @overload
...
class Parallel:
    ...
    with_options: Any  # alias to copy
...
# -----------------------------------------------------------------------------
# Public aliasing from package __init__.py
# -----------------------------------------------------------------------------
Client = Parallel
...
# =============================================================================
# Misc helpers re-exported at top-level
# =============================================================================
...
# =============================================================================
# resources proxy (parallel.resources) - exposed at runtime
# =============================================================================

class resources: ...
```

If you want this to be *truly exhaustive* (every single model/TypedDict/event union, including all beta FindAll event variants, and the “with_raw_response / with_streaming_response” wrappers), I can expand the stub—but I’d need either:
1) the remaining files not shown in your excerpt (e.g. `parallel/resources/__init__.py` wrappers and any missing type definitions), or  
2) permission to generate a best-effort stub that may include some placeholders for missing docstrings/types.