...
// Summary .d.ts for the package represented by the provided src/ tree.
...
declare const VERSION: '0.3.1'; // x-release-please-version
...
/* ============================================================
 * resources/beta/* (Beta namespace + subresources)
 * ============================================================ */
