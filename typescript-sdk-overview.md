Below is a single, consolidated **`parallel-sdk-footprint.d.ts`** file that summarizes the *public* API surface (what an LLM/user would import and use) based on the code you provided. I’ve included doc-comments **1:1 where they exist on the public surface** (notably in resource/type declarations). I did **not** invent new doc-comments.

> Notes / assumptions:
> - This is a *summary* `.d.ts`, not a byte-for-byte reproduction of every internal helper. It focuses on the SDK’s public footprint: `Parallel` client, request options, errors, streaming, uploads, and resources (`taskRun`, `beta.*`).
> - Internal modules under `src/internal/**` are intentionally not exported by the package; they’re omitted except where their types are re-exposed (e.g., `RequestOptions`, `Uploadable`).
> - Some doc-comments exist only on internal modules; those are not included because they are not part of the public API surface.

```ts
// parallel-sdk-footprint.d.ts
// Consolidated public API footprint for the Parallel TypeScript SDK.
...
declare class Parallel {
  ...
  /**
   * Primary non-beta TaskRun resource (v1).
   */
  taskRun: Parallel.TaskRunResource;

  /**
   * Beta namespace containing beta resources and beta endpoints (v1beta + beta=true variants).
   */
  beta: Parallel.BetaResource;

  // Static exports/aliases exposed by the package.
...
// Default export in src/index.ts is Parallel.
declare const _default: typeof Parallel;
...
export declare namespace Parallel {
  ...
  // ---- fetch / request-init compatibility layer ----
  ...
  export type ToFileInput =
    ...
    | AsyncIterable<string | ArrayBuffer | Uint8Array | null | undefined>;
  ...
  export class TaskRunResource {
     ...
     */
    create(body: Parallel.TaskRunCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.TaskRun>;
     ...
     */
    retrieve(runID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.TaskRun>;
    ...
    result(
      runID: string,
      query?: Parallel.TaskRunResultParams | null | undefined,
      options?: Parallel.RequestOptions,
    ): Parallel.APIPromise<Parallel.TaskRunResult>;
  }
  ...
  export class BetaResource {
     ...
     */
    extract(params: Parallel.BetaExtractParams, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.ExtractResponse>;
     ...
     * `search-extract-2025-10-10`.
     */
    search(params: Parallel.BetaSearchParams, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.SearchResult>;
  }
  ...
  export class BetaTaskRunResource {
    /**
     * Initiates a task run.
     *
     * Returns immediately with a run object in status 'queued'.
  ...
  export class BetaTaskGroupResource {
    /**
  ...
  export class BetaFindAllResource {
    /**
  ...
  // -----------------------------
  // Back-compat type aliases (from beta/findall.ts)
  // -----------------------------
   ...
   */
  export class Findall extends BetaFindAllResource {}
  ...
  export type FindallExtendInput = { additional_match_limit: number };
  ...
  export type FindallIngestInput = { objective: string };
...
// -----------------------------
// Top-level named exports (src/index.ts)
// -----------------------------

export declare const APIPromise: typeof Parallel.APIPromise;

export declare const toFile: typeof Parallel.toFile;
export declare type Uploadable = Parallel.Uploadable;

export declare const ParallelError: typeof Parallel.ParallelError;
export declare const APIError: typeof Parallel.APIError;
export declare const APIConnectionError: typeof Parallel.APIConnectionError;
export declare const APIConnectionTimeoutError: typeof Parallel.APIConnectionTimeoutError;
export declare const APIUserAbortError: typeof Parallel.APIUserAbortError;
export declare const NotFoundError: typeof Parallel.NotFoundError;
export declare const ConflictError: typeof Parallel.ConflictError;
export declare const RateLimitError: typeof Parallel.RateLimitError;
export declare const BadRequestError: typeof Parallel.BadRequestError;
export declare const AuthenticationError: typeof Parallel.AuthenticationError;
export declare const InternalServerError: typeof Parallel.InternalServerError;
export declare const PermissionDeniedError: typeof Parallel.PermissionDeniedError;
export declare const UnprocessableEntityError: typeof Parallel.UnprocessableEntityError;
```

If you want, I can also generate an **LLM-friendly “API map”** alongside this (still as `.d.ts`, but with an additional “entrypoint walkthrough” section showing the main call flows: create run → poll result; create group → add runs → stream events; beta search/extract; FindAll create → events/result/schema/enrich/extend/cancel).