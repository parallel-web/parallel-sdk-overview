...
// Summarized public API footprint of the provided TypeScript SDK sources.
...
/* -------------------- Backwards-compatible Findall aliases ------------------- */
...
export {
  Parallel as ParallelClass, // alias-friendly
  ClientOptions as ParallelClientOptions,
  Uploadable,
  toFile,
  APIPromise,
  Stream,
