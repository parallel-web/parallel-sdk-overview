...
// A single-file public TypeScript declaration footprint for the Parallel SDK.
...
declare namespace Parallel {
  ...
  // --- Fetch / RequestInit compatibility surface (public types) ---
  ...
  // --- Beta: TaskRun (events + beta result types) ---
  ...
  export class BetaTaskRunResource {
     ...
     */
    events(runID: string, options?: RequestOptions): APIPromise<Stream<BetaTaskRunEventsResponse>>;
...
export { Parallel };
export type { Parallel as ParallelClient };
```