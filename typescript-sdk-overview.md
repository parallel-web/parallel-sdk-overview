...
// Summarized public API footprint for the Parallel TypeScript SDK (v0.3.1)
// Notes:
// - This is a single-file declaration overview intended for LLM/tooling consumption.
// - Doc-comments are copied 1:1 where available in the provided sources.
// - Internal (non-importable) modules are omitted unless they surface through public types.
...
declare class Parallel {
  ...
  static DEFAULT_TIMEOUT: number; // 60000
  ...
  static Beta: typeof Parallel.Resources.Beta;
}
...
declare namespace Parallel {
  ...
  export type HeadersLike =
    ...
    | undefined
    | null
    | any; // NullableHeaders internal brand
  ...
  export namespace Resources {
    ...
    // --------------------------
    // Resources: Beta (v1beta)
    // --------------------------

    export class Beta {
      taskRun: Resources.BetaTaskRun;
      taskGroup: Resources.TaskGroup;
      findall: Resources.FindAll;
    ...
    export interface BetaExtractParams {
       ...
       */
      betas?: Array<Resources.BetaTaskRun.ParallelBeta>;
    }
    ...
    // --------------------------
    // Beta: TaskRun (events, MCP, webhooks, beta result)
    // --------------------------

    export class BetaTaskRun {
      /**
       * Initiates a task run.
       *
       * Returns immediately with a run object in status 'queued'.
       ...
       * Beta features can be enabled by setting the 'parallel-beta' header.
       */
      create(params: BetaTaskRun.TaskRunCreateParams, options?: RequestOptions): APIPromise<TaskRunObject>;
       ...
       */
      events(runID: string, options?: RequestOptions): APIPromise<Stream<BetaTaskRun.TaskRunEventsResponse>>;
      ...
      result(
        ...
        options?: RequestOptions,
      ): APIPromise<BetaTaskRun.BetaTaskRunResult>;
    }
  ...
  // Convenience re-exports matching src/client.ts "declare namespace Parallel"
  export import TaskRun = Resources.TaskRunObject;
  export import AutoSchema = Resources.AutoSchema;
  export import Citation = Resources.Citation;
  export import FieldBasis = Resources.FieldBasis;
  export import JsonSchema = Resources.JsonSchema;
  export import RunInput = Resources.RunInput;
  export import TaskRunJsonOutput = Resources.TaskRunJsonOutput;
  export import TaskRunResult = Resources.TaskRunResult;
  export import TaskRunTextOutput = Resources.TaskRunTextOutput;
  export import TaskSpec = Resources.TaskSpec;
  export import TextSchema = Resources.TextSchema;
  export import TaskRunCreateParams = Resources.TaskRunCreateParams;
  export import TaskRunResultParams = Resources.TaskRunResultParams;

  export import Beta = Resources.Beta;

  export type ErrorObject = Parallel.ErrorObject;
  export type ErrorResponse = Parallel.ErrorResponse;
  export type Warning = Parallel.Warning;
  export type SourcePolicy = Parallel.SourcePolicy;
}
