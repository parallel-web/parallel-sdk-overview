...
// Summary .d.ts of the public API surface from the provided source tree.
// Doc-comments are copied 1:1 where present in the sources.
  ...
  export class APIPromise<T> extends Promise<T> {
    constructor(
      ...
      responsePromise: Promise<{
        response: Response;
        options: import('./internal/request-options').FinalRequestOptions;
...
declare module './internal/uploads' {
  ...
  export function makeFile(fileBits: BlobPart[], fileName: string | undefined, options?: any): File;
...
declare module './client' {
  ...
  import type * as Opts from './internal/request-options';
  ...
  export interface ClientOptions {
     ...
     */
    logLevel?: import('./internal/utils/log').LogLevel | undefined;
     ...
     */
    logger?: import('./internal/utils/log').Logger | undefined;
  }
  ...
  export class Parallel {
    ...
    maxRetries: number;
    timeout: number;
    logger: import('./internal/utils/log').Logger;
    logLevel: import('./internal/utils/log').LogLevel | undefined;
    fetchOptions: MergedRequestInit | undefined;
...
declare module './resources/beta/findall' {
  ...
  // Types are extensive; for LLM footprint, they are included as declared in source.
