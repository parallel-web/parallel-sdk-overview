...
// Doc-comments copied 1:1 from the provided source where available.
...
declare class Parallel {
  ...
  async fetchWithTimeout(
    url: Parallel.RequestInfo,
    init: Parallel.RequestInit | undefined,
    ms: number,
    controller: AbortController,
  ): Promise<Parallel.Response>;

  async buildRequest(
    inputOptions: Parallel.FinalRequestOptions,
    options?: { retryCount?: number },
  ): Promise<{ req: Parallel.FinalizedRequestInit; url: string; timeout: number }>;
...
declare namespace Parallel {
  ...
  export type ToFileInput =
    | (Blob & { readonly name?: string | undefined; readonly lastModified: number; text(): Promise<string>; slice(start?: number, end?: number): any; arrayBuffer(): Promise<ArrayBuffer> })
  ...
  export type HeadersLike =
    ...
    | undefined
    | null
    | any; // internal NullableHeaders brand
  ...
  // Minimal builtin types (as used publicly)
  export type Fetch = (input: string | URL | Request, init?: globalThis.RequestInit) => Promise<Response>;
  ...
  export namespace Resources {
    ...
    export class TaskRun {
       ...
       */
      create(body: TaskRunCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskRunObject>;
       ...
       */
      retrieve(runID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskRunObject>;
    ...
    export class Beta {
       ...
       */
      extract(params: Beta.BetaExtractParams, options?: Parallel.RequestOptions): Parallel.APIPromise<Beta.ExtractResponse>;
       ...
       * `search-extract-2025-10-10`.
       */
      search(params: Beta.BetaSearchParams, options?: Parallel.RequestOptions): Parallel.APIPromise<Beta.SearchResult>;
    }
    ...
    export namespace Beta {
      ...
      export interface ExtractResponse {
         ...
         */
        warnings?: Array<Parallel.Resources.Warning> | null;
      }
      ...
      export interface BetaExtractParams {
         ...
         */
        betas?: Array<BetaTaskRun.ParallelBeta>;
      }
      ...
      export interface BetaSearchParams {
         ...
         * This policy governs which sources are allowed/disallowed in results.
         */
        source_policy?: Parallel.Resources.SourcePolicy | null;
      ...
      export class TaskRun {
         ...
         * Beta features can be enabled by setting the 'parallel-beta' header.
         */
        create(params: BetaTaskRun.TaskRunCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.Resources.TaskRunObject>;
         ...
         */
        events(runID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.Stream<BetaTaskRun.TaskRunEventsResponse>>;
        ...
        result(
          runID: string,
          params?: BetaTaskRun.TaskRunResultParams | null | undefined,
          options?: Parallel.RequestOptions,
        ): Parallel.APIPromise<BetaTaskRun.BetaTaskRunResult>;
      }

      export namespace BetaTaskRun {
        /**
        ...
        export interface BetaRunInput {
           ...
           * For convenience bare strings are also accepted as input or output schemas.
           */
          task_spec?: Parallel.Resources.TaskSpec | null;
        ...
        export interface BetaTaskRunResult {
           ...
           */
          run: Parallel.Resources.TaskRunObject;
        }
        ...
        export namespace BetaTaskRunResult {
          ...
          export interface BetaTaskRunTextOutput {
             ...
             * run.
             */
            basis: Array<Parallel.Resources.FieldBasis>;
        ...
        export interface ErrorEvent {
           ...
           * Error.
           */
          error: Parallel.Resources.ErrorObject;
        ...
        export interface TaskRunEvent {
           ...
           */
          output?: Parallel.Resources.TaskRunTextOutput | Parallel.Resources.TaskRunJsonOutput | null;
        }
      ...
      export class TaskGroup {
         ...
         */
        create(body: TaskGroupCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskGroupObject>;

        /**
         * Retrieves aggregated status across runs in a TaskGroup.
         */
        retrieve(taskGroupID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskGroupObject>;
      ...
      export type TaskGroupEventsResponse =
        ...
        | BetaTaskRun.TaskRunEvent
        | BetaTaskRun.ErrorEvent;
       ...
       * May indicate completion, cancellation, or failure.
       */
      export type TaskGroupGetRunsResponse = BetaTaskRun.TaskRunEvent | BetaTaskRun.ErrorEvent;
      ...
      export interface TaskGroupAddRunsParams {
         ...
         */
        inputs: Array<BetaTaskRun.BetaRunInput>;
         ...
         * For convenience bare strings are also accepted as input or output schemas.
         */
        default_task_spec?: Parallel.Resources.TaskSpec | null;
      ...
      // Types for FindAll (doc-comments preserved where present in snippet)
      ...
      export namespace FindAllCandidateMatchStatusEvent {
        export interface Data {
          ...
          basis?: Array<Parallel.Resources.FieldBasis> | null;
          description?: string | null;
      ...
      export interface FindAllEnrichInput {
         ...
         */
        output_schema: Parallel.Resources.JsonSchema;

        /**
         * List of MCP servers to use for the task.
         */
        mcp_servers?: Array<BetaTaskRun.McpServer> | null;
      ...
      export interface FindAllCreateParams {
        ...
        metadata?: { [key: string]: string | number | boolean } | null;
        webhook?: BetaTaskRun.Webhook | null;
        betas?: Array<BetaTaskRun.ParallelBeta>;
      }
      ...
      // Back-compat deprecated aliases exist in source, omitted from footprint by default.
    }
  }

  // Re-export key resource types at top-level namespace (mirroring src/client.ts declare namespace Parallel)
  export type TaskRun = Resources.TaskRunObject;
  export type AutoSchema = Resources.AutoSchema;
  export type Citation = Resources.Citation;
  export type FieldBasis = Resources.FieldBasis;
  export type JsonSchema = Resources.JsonSchema;
  export type RunInput = Resources.RunInput;
  export type TaskRunJsonOutput = Resources.TaskRunJsonOutput;
  export type TaskRunResult = Resources.TaskRunResult;
  export type TaskRunTextOutput = Resources.TaskRunTextOutput;
  export type TaskSpec = Resources.TaskSpec;
  export type TextSchema = Resources.TextSchema;
  export type TaskRunCreateParams = Resources.TaskRunCreateParams;
  export type TaskRunResultParams = Resources.TaskRunResultParams;

  export type ErrorObject = Resources.ErrorObject;
  export type ErrorResponse = Resources.ErrorResponse;
  export type SourcePolicy = Resources.SourcePolicy;
  export type Warning = Resources.Warning;

  export const Beta: typeof Resources.Beta;
}
