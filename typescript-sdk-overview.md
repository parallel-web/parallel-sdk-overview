...
// Doc-comments are copied 1:1 where present in the provided sources.
...
declare class Parallel {
   ...
   */
  constructor(options?: Parallel.ClientOptions);
  ...
  get<Rsp>(path: string, opts?: Parallel.PromiseOrValue<Parallel.RequestOptions>): Parallel.APIPromise<Rsp>;
  post<Rsp>(path: string, opts?: Parallel.PromiseOrValue<Parallel.RequestOptions>): Parallel.APIPromise<Rsp>;
  patch<Rsp>(path: string, opts?: Parallel.PromiseOrValue<Parallel.RequestOptions>): Parallel.APIPromise<Rsp>;
  put<Rsp>(path: string, opts?: Parallel.PromiseOrValue<Parallel.RequestOptions>): Parallel.APIPromise<Rsp>;
  delete<Rsp>(path: string, opts?: Parallel.PromiseOrValue<Parallel.RequestOptions>): Parallel.APIPromise<Rsp>;

  taskRun: Parallel.Resources.TaskRun;
  beta: Parallel.Resources.Beta;

  static DEFAULT_TIMEOUT: number;

  static ParallelError: typeof Parallel.ParallelError;
  static APIError: typeof Parallel.APIError;
  static APIConnectionError: typeof Parallel.APIConnectionError;
  static APIConnectionTimeoutError: typeof Parallel.APIConnectionTimeoutError;
  static APIUserAbortError: typeof Parallel.APIUserAbortError;
  static NotFoundError: typeof Parallel.NotFoundError;
  static ConflictError: typeof Parallel.ConflictError;
  static RateLimitError: typeof Parallel.RateLimitError;
  static BadRequestError: typeof Parallel.BadRequestError;
  static AuthenticationError: typeof Parallel.AuthenticationError;
  static InternalServerError: typeof Parallel.InternalServerError;
  static PermissionDeniedError: typeof Parallel.PermissionDeniedError;
  static UnprocessableEntityError: typeof Parallel.UnprocessableEntityError;

  static toFile: typeof Parallel.toFile;
  static Beta: typeof Parallel.Resources.BetaClass;
}
...
export declare namespace Parallel {
  ...
  export interface ClientOptions {
     ...
     */
    fetch?: Parallel.Fetch | undefined;
  ...
  export type RequestOptions = {
    ...
    __streamClass?: typeof Parallel.Stream;
  };
  ...
  export namespace Uploads {
    ...
    export type ToFileInput =
      ...
      | AsyncIterable<string | ArrayBuffer | ArrayBufferView | Blob | DataView | any>;
     ...
     */
    export function toFile(value: ToFileInput | PromiseLike<ToFileInput>, name?: string | null | undefined, options?: any): Promise<File>;
  }

  export import toFile = Uploads.toFile;
  export type Uploadable = Uploads.Uploadable;
  ...
  export class Stream<Item> implements AsyncIterable<Item> {
     ...
     */
    static fromReadableStream<Item>(readableStream: any, controller: AbortController, client?: Parallel): Stream<Item>;
  }
  ...
  export namespace Resources {
    ...
    export class TaskRun extends APIResource {
       ...
       */
      create(body: TaskRunCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskRunModel>;
       ...
       */
      retrieve(runID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskRunModel>;
      ...
      ): Parallel.APIPromise<TaskRunResult>;
    }
    ...
    export class Beta extends APIResource {
       ...
       */
      extract(params: BetaExtractParams, options?: Parallel.RequestOptions): Parallel.APIPromise<ExtractResponse>;
       ...
       * `search-extract-2025-10-10`.
       */
      search(params: BetaSearchParams, options?: Parallel.RequestOptions): Parallel.APIPromise<SearchResult>;
    }

    export class BetaClass extends Beta {}
    ...
    // -------------------------
    // Beta TaskRun (events/result w/ betas)
    // -------------------------

    export type BetaParallelBeta =
    ...
    export class BetaTaskRun extends APIResource {
      /**
       * Initiates a task run.
       *
       * Returns immediately with a run object in status 'queued'.
       ...
       * Beta features can be enabled by setting the 'parallel-beta' header.
       */
      create(params: BetaTaskRunCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskRunModel>;
       ...
       */
      events(runID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<Parallel.Stream<BetaTaskRunEventsResponse>>;
      ...
      result(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<BetaTaskRunResult>;
    }
     ...
     */
    export type BetaTaskRunEventsResponse =
    ...
    export class BetaTaskGroup extends APIResource {
      /**
       * Initiates a TaskGroup to group and track multiple runs.
       */
      create(body: TaskGroupCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskGroup>;

      /**
       * Retrieves aggregated status across runs in a TaskGroup.
       */
      retrieve(taskGroupID: string, options?: Parallel.RequestOptions): Parallel.APIPromise<TaskGroup>;
      ...
      addRuns(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<TaskGroupRunResponse>;
      ...
      events(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<Parallel.Stream<TaskGroupEventsResponse>>;
      ...
      getRuns(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<Parallel.Stream<TaskGroupGetRunsResponse>>;
    }
    ...
    export class FindAll extends APIResource {
       ...
       */
      create(params: FindAllCreateParams, options?: Parallel.RequestOptions): Parallel.APIPromise<FindAllRun>;
      ...
      retrieve(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<FindAllRun>;
      ...
      enrich(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<FindAllSchema>;
      ...
      events(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<Parallel.Stream<FindAllEventsResponse>>;
       ...
       */
      ingest(params: FindAllIngestParams, options?: Parallel.RequestOptions): Parallel.APIPromise<FindAllSchema>;
      ...
      result(
        ...
        options?: Parallel.RequestOptions,
      ): Parallel.APIPromise<FindAllRunResult>;
  ...
  // Convenience re-exports at top-level namespace (as per /src/index.ts & client namespace)
  export import APIPromise = Parallel.APIPromise;
  export import Stream = Parallel.Stream;

  export import ParallelError = Parallel.ParallelError;
  export import APIError = Parallel.APIError;
  export import APIConnectionError = Parallel.APIConnectionError;
  export import APIConnectionTimeoutError = Parallel.APIConnectionTimeoutError;
  export import APIUserAbortError = Parallel.APIUserAbortError;
  export import NotFoundError = Parallel.NotFoundError;
  export import ConflictError = Parallel.ConflictError;
  export import RateLimitError = Parallel.RateLimitError;
  export import BadRequestError = Parallel.BadRequestError;
  export import AuthenticationError = Parallel.AuthenticationError;
  export import InternalServerError = Parallel.InternalServerError;
  export import PermissionDeniedError = Parallel.PermissionDeniedError;
  export import UnprocessableEntityError = Parallel.UnprocessableEntityError;

  export type ErrorObject = Parallel.Resources.ErrorObject;
  export type ErrorResponse = Parallel.Resources.ErrorResponse;
  export type SourcePolicy = Parallel.Resources.SourcePolicy;
  export type Warning = Parallel.Resources.Warning;

  export type TaskRun = Parallel.Resources.TaskRunModel;
  export type AutoSchema = Parallel.Resources.AutoSchema;
  export type Citation = Parallel.Resources.Citation;
  export type FieldBasis = Parallel.Resources.FieldBasis;
  export type JsonSchema = Parallel.Resources.JsonSchema;
  export type RunInput = Parallel.Resources.RunInput;
  export type TaskRunJsonOutput = Parallel.Resources.TaskRunJsonOutput;
  export type TaskRunResult = Parallel.Resources.TaskRunResult;
  export type TaskRunTextOutput = Parallel.Resources.TaskRunTextOutput;
  export type TaskSpec = Parallel.Resources.TaskSpec;
  export type TextSchema = Parallel.Resources.TextSchema;
  export type TaskRunCreateParams = Parallel.Resources.TaskRunCreateParams;
  export type TaskRunResultParams = Parallel.Resources.TaskRunResultParams;

  export type Uploadable = Parallel.Uploads.Uploadable;
  export const toFile: typeof Parallel.Uploads.toFile;
}
```