...
// Summarized public TypeScript API surface for the provided SDK source tree.
// Doc-comments are copied 1:1 where present in the source (no wording changes).
...
export class APIPromise<T> extends Promise<T> {
  constructor(
    ...
    responsePromise: Promise<{
      response: Response;
      options: Parallel.RequestOptions & { method: Parallel.HTTPMethod; path: string };
...
/* ============================================================
 * Internal-shimmed / exported types used publicly
 * ============================================================ */
...
/* ============================================================
 * Resources: Beta (v1beta) - Search/Extract + TaskRun Events/Result + TaskGroup + FindAll
 * ============================================================ */
...
export namespace Beta {
  export class TaskRun extends APIResource {
     ...
     * Beta features can be enabled by setting the 'parallel-beta' header.
     */
    create(params: TaskRunCreateParams, options?: Parallel.RequestOptions): APIPromise<TaskRunModel>;
...
export default class Parallel {
  ...
  request<Rsp>(options: Parallel.PromiseOrValue<Parallel.FinalRequestOptions>, remainingRetries?: number | null): APIPromise<Rsp>;
...
export declare namespace Parallel {
  // Request/transport types (publicly re-exported / referenced in docs)
  ...
  // NullableHeaders are part of the public header contract via HeadersLike
  export type NullableHeaders = {
    /** Parsed headers. */
    values: Headers;
    /** Set of lowercase header names explicitly set to null. */
    nulls: Set<string>;
  } & { readonly __brand_privateNullableHeaders?: true };

  // Public resource type re-exports (as in client.ts namespace)
  ...
  export type ReadableStream<R = any> = import('./parallel-sdk-footprint').ReadableStream<R>;
}
