...
// Summarized public TypeScript declaration footprint for the SDK shown in the provided tree.
// Doc-comments are copied 1:1 where available (verbatim).
...
declare module 'parallel/core/api-promise' {
  ...
  export class APIPromise<T> extends Promise<T> {
    ...
    // Standard Promise methods are overridden to lazily parse.
...
declare module 'parallel/internal/request-options' {
  ...
  export type RequestOptions = {
     ...
     */
    headers?: Headers | readonly (string | undefined | null)[][] | Record<string, any> | undefined | null;
...
declare module 'parallel/resources/beta/findall' {
  ...
  // Backwards-compatible alias resource
  ...
  // Deprecated lowercase-a aliases (types only)
...
declare module 'parallel/resources/beta/beta' {
  ...
  import { TaskRun as BetaTaskRunResource, type ParallelBeta } from 'parallel/resources/beta/task-run';
...
declare module 'parallel/client' {
  ...
  import type { Logger, LogLevel } from 'parallel/internal/utils/log';
  import type { Stream } from 'parallel/core/streaming';
  import type * as Opts from 'parallel/internal/request-options';
  import type * as Errors from 'parallel/core/error';
  import type * as Uploads from 'parallel/core/uploads';
  ...
  export class Parallel {
    ...
    get<Rsp>(path: string, opts?: Opts.RequestOptions | Promise<Opts.RequestOptions>): APIPromise<Rsp>;
    post<Rsp>(path: string, opts?: Opts.RequestOptions | Promise<Opts.RequestOptions>): APIPromise<Rsp>;
    patch<Rsp>(path: string, opts?: Opts.RequestOptions | Promise<Opts.RequestOptions>): APIPromise<Rsp>;
    put<Rsp>(path: string, opts?: Opts.RequestOptions | Promise<Opts.RequestOptions>): APIPromise<Rsp>;
    delete<Rsp>(path: string, opts?: Opts.RequestOptions | Promise<Opts.RequestOptions>): APIPromise<Rsp>;
  ...
  // Static alias (present in runtime code)
  export namespace Parallel {
    export { Beta as Beta };
  }
}
