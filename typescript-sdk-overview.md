...
//
// Notes:
// - This is a "footprint" declaration: it aims to show how to use the SDK and what it exposes.
// - Internal modules under ./internal are intentionally not exported in this footprint.
// - Doc-comments included below are copied 1:1 where available in the provided sources.

declare module 'parallel-sdk-footprint' {
  /* ===========================
   * Version
   * =========================== */
  ...
  /* ===========================
   * Request Options (publicly referenced)
   * =========================== */
  ...
  export class Parallel {
    ...
    request<Rsp>(options: (RequestOptions & { method: HTTPMethod; path: string }) | Promise<any>): APIPromise<Rsp>;

    // Resources
    taskRun: TaskRunResource;
    beta: BetaResource;

    // Static exports (as attached properties)
  ...
  // Default export behavior in the real package: `export { Parallel as default }`
