...
// A single-file public API footprint summary for the provided TypeScript SDK source.
//
// Notes:
// - This is a *declaration-only* view intended for LLM/tooling consumption.
// - Doc-comments are copied 1:1 where present in the source snippets you provided.
// - Internal modules are intentionally omitted (not part of the public surface).
// - Deprecated re-exports are included where they exist in /src/*.ts.
...
declare module 'parallel/core/uploads' {
  export { type Uploadable } from 'parallel/internal/uploads'; // type-only alias to internal definition
...
declare module 'parallel/resources/beta/task-run' {
  ...
  export class TaskRun extends APIResource {
     ...
     * Beta features can be enabled by setting the 'parallel-beta' header.
     */
    create(params: TaskRunCreateParams, options?: Parallel.RequestOptions): APIPromise<TaskRunAPI.TaskRun>;
...
declare module 'parallel/client' {
  ...
  import * as Opts from 'parallel/internal/request-options'; // type-only
  ...
  export class Parallel {
    ...
    get<Rsp>(path: string, opts?: any): import('parallel/core/api-promise').APIPromise<Rsp>;
    post<Rsp>(path: string, opts?: any): import('parallel/core/api-promise').APIPromise<Rsp>;
    patch<Rsp>(path: string, opts?: any): import('parallel/core/api-promise').APIPromise<Rsp>;
    put<Rsp>(path: string, opts?: any): import('parallel/core/api-promise').APIPromise<Rsp>;
    delete<Rsp>(path: string, opts?: any): import('parallel/core/api-promise').APIPromise<Rsp>;
...
/**
 * Minimal “public” request options type (the SDK exports this as Parallel.RequestOptions).
 * This is referenced in many resources; we surface it here for LLM comprehension.
 */
